...
public class OverrallFrame extends javax.swing.JFrame implements MouseListener {
    ...
    String arr[] = {"TRANG CHỦ", "NHẬP THÔNG TIN TÀI SẢN","KIỂM KÊ"
            ,"XUẤT BÁO CÁO"};
    String arrIcon[] = {"icons8-home-page-20.png","icons8-collectibles-20.png","icons8-reception-20.png","icons8-increase-20.png"};
    ...
    private void initComponents() {
        ...
        jPanel2.add(LeftPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 240, 210, 190));
        ...
        jLabel8.setText("CHUYÊN ĐỀ SEMINAR");
        headerPanel.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 0, 480, 70));
    ...
    public static void changeMainInfo(int i)
    {
        ...
        switch(i)
        {
            case 1: //  Trang chủ            
                ...
                content.revalidate();
                break;
            case 2: // insertRegister
                content.removeAll();
                p1 = new AddRegistertPanel();
                p1.setSize(800,600);
                content.add(p1);
                content.repaint();
                content.revalidate();
            ...
            case 12: //AddInventoryPanel
                content.removeAll();
                p1 = new AddInventoryPanel();
                p1.setSize(800,600);
                content.add(p1);
                content.repaint();
                content.revalidate();
                break;
            case 13: //ChiTietKiemKe
                content.removeAll();
                p1 = new ChiTietKiemKe();
                p1.setSize(800,600);
                content.add(p1);
                content.repaint();
                content.revalidate();
